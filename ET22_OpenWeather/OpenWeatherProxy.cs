...
//
//    var openWeatherProxy = OpenWeatherProxy.FromJson(jsonString);
...
namespace ET22_OpenWeather
{
    ...
    public partial class OpenWeatherProxy
    {
        public static OpenWeatherProxy FromJson(string json) => JsonConvert.DeserializeObject<OpenWeatherProxy>(json, ET22_OpenWeather.Converter.Settings);
    }
